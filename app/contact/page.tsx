        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-8">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Ready to transform your business with AI? Schedule a demo or get in touch 
              with our team to discuss your specific needs and challenges.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            ...
            <Card className="text-center p-8 border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="space-y-4">
                ...
                <h3 className="text-2xl font-bold text-gray-900">Start a Project</h3>
                <p className="text-gray-600 leading-relaxed">
                ...
                <Card className="p-6 border-l-4 border-l-blue-600">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:hello@savant.com" className="text-blue-600 hover:underline">
                        hello@savant.com
                      </a>
                    </div>
                  </div>
